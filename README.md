...
*A lightweight, ML-centric digital twin for CubeSat onboard AI research.* (This is just an initial phase and the rest of the project's development will be delayed) 
